...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>此問卷的受測者多數來自工作室的藝術工作者，其次則是替代空間</li>
    <li>大部分藝術工作者採取減少碳排放的行動前三名為減少包裝、使用再生材料、節約能源</li>
    <li>美術館的藝術工作者除了減少包裝外也會節約工作場所的能源，和其他場所相較來說使用再生材料則不是他們的前三名選擇</li>
  </ul>
</h3>`
)}
...
d3
  ...
  .range(["#E60000","#f9a52c","#efdf48","#8bd346","#16a4d8","	#9b5fe0"])
  .unknown("#D3D3D3")
)}
